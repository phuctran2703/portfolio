  ...
  return (
    <div className="rounded-lg border border-gray-100 bg-card text-card-foreground shadow-sm transition-transform duration-300 hover:shadow-md hover:-translate-y-1">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-2 lg:gap-4">
          <div className="flex items-center gap-3 text-center lg:text-left">
            ...
            <div>
              ...
              <p className="flex items-center justify-center lg:justify-start gap-1 mt-1 text-sm text-muted-foreground flex-wrap">
                <MapPin className="h-3 w-3 text-gray-600 flex-shrink-0" /> 
                <span>{location}</span> • <span className="font-medium text-gray-600">{type}</span>
              </p>
            </div>
          </div>
      ...
      <div className="p-4 sm:p-6 pt-2 space-y-3 sm:space-y-4">
        <p className="text-sm sm:text-base text-muted-foreground leading-relaxed text-gray-600">{description}</p>
        <div>
          <h4 className="font-semibold mb-2 sm:mb-3 text-base sm:text-lg">Key Responsibilities:</h4>
