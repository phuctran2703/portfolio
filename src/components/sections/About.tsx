...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="py-16 md:py-20 scroll-mt-16 px-4 md:px-8 lg:px-20 bg-[#F9FAFB]"
    >
      <div className="max-w-4xl mx-auto flex flex-col items-center space-y-6">
        <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight text-center">About Me</h2>
        <div className="w-full">
          <p className="text-base lg:text-lg text-muted-foreground leading-relaxed md:leading-loose text-justify dark:text-gray-700 max-w-3xl mx-auto">
