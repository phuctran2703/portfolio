...
export default function IntroduceSection() {
  return (
    <section id="introduce" className="min-h-[calc(100vh-4rem)] flex flex-col scroll-mt-20">
      <div className="min-h-[calc(100vh-4rem)] flex flex-col lg:flex-row gap-8 items-center">
        <div className="md:w-2/3 flex flex-col gap-8 order-2 lg:order-1 max-w-3xl">
          <div className="space-y-6">
            ...
            <p className="text-base lg:text-lg text-muted-foreground max-w-2xl leading-relaxed md:leading-loose text-justify dark:text-gray-300">
